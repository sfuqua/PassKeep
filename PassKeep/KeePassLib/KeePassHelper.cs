...
{
    public static class KeePassHelper
    {
        /// <summary>
        /// The KeePass raw k is 32 bytes generated by the SHA-256 hash of the
        /// concatenation of all user security data.
        /// </summary>
        /// <param name="password">The string password used to encrypt to the database</param>
        ...
        /// from the database metadata</param>
        /// <param name="_transformRounds">The number of times to mutate the k</param>
        /// <returns>A mutated k used to encrypt/decrypt the database</returns>
