...
namespace PassKeep.Common
{
    ...
    /// </item>
    /// <item>
    /// <description>GoUp, GoForward, and GoHome event handlers</description>
    /// </item>
    /// <item>
    /// <description>Mouse and keyboard shortcuts for navigation</description>
    /// </item>
    /// <item>
    /// <description>Error management for navigation and process lifetime management</description>
    /// </item>
    /// <item>
    ...
    public class LayoutAwarePage : Page
    {
        ...
        /// <summary>
        /// Invoked on every keystroke, including system keys such as Alt k combinations, when
            ...
            AcceleratorKeyEventArgs args)
        {
                ...
                (int)virtualKey == 166 || (int)virtualKey == 167))
            {
                ...
                {
                    // When the previous k or Alt+Left are pressed navigate back
                    args.Handled = true;
                ...
                {
                    // When the next k or Alt+Right are pressed navigate forward
                    args.Handled = true;
