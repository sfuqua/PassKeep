...
namespace PassKeep.Views
{
    ...
    public sealed partial class EntryDetailsView : EntryDetailsViewBase
    {
        ...
        public IFieldEditorViewModel FieldEditViewModel { get; set; }
        ...
        public EntryDetailsView()
        {
            ...
            copyFieldButton.Click += (s, e_i) =>
            {
                ...
                package.SetText(((IProtectedString)fieldsGridView.SelectedItem).ClearValue);
            ...
            editFieldButton.Click += (s, e_i) =>
            {
                ...
                IProtectedString clicked = (IProtectedString)fieldsGridView.SelectedItem;
        ...
        private void kdbxStringPopupTL(double top, double left, IProtectedString str = null)
        {
            var bounds = Window.Current.CoreWindow.Bounds;
        ...
        private void kdbxStringPopupBR(double bottom, double right, IProtectedString str = null)
        {
            var bounds = Window.Current.CoreWindow.Bounds;
            double maxBottom = (bounds.Bottom - bounds.Top);
            if (BottomAppBar.IsOpen)
