...
int Rijndael::Init(Mode mode, Direction dir, const uint8 *key, KeyLength keyLen, const uint8 *initVector)
{
...
void Rijndael::KeySched(uint8 key[RD_MAX_KEY_COLUMNS][4])
{
    int j, rconpointer = 0;
